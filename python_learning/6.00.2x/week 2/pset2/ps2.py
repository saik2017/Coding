...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        # if pos.getX()==self.width:
        #     x=self.width-1
        # if pos.getY()==self.height:
        #     y=self.height-1
    ...
    def getNumCleanedTiles(self):
        ...
        returns: an integer
        """
        return sum(list(self.tiles.values()))
...
#
#       (... your call here ...)
showPlot1("mean time vs num robots","num robots","mean time")
...
#
#       (... your call here ...)
showPlot2("mean time vs Aspect ratio","Aspect ratio","mean time")
